...
public class phonesFrame extends javax.swing.JFrame {
    ...
    public void updateAddDelPhones(){
        try{
             phbrcode = phbranchcodetxt.getText();
             phnum = phphonenumtxt.getText();
    ...
    private void initComponents() {
        ...
        phbranchcodetxt = new javax.swing.JTextField();
        ...
        phphonenumtxt = new javax.swing.JTextField();
        jPanel5 = new javax.swing.JPanel();
        jLabel6 = new javax.swing.JLabel();
        btnViewPh = new javax.swing.JButton();
        ...
        btnRESETbr.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 520, 680, 260));

        phbranchcodetxt.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        phbranchcodetxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                phbranchcodetxtActionPerformed(evt);
            }
        });
        btnRESETbr.add(phbranchcodetxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 460, 30));
        ...
        phphonenumtxt.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        phphonenumtxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                phphonenumtxtActionPerformed(evt);
            }
        });
        btnRESETbr.add(phphonenumtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 390, 460, 30));
        ...
        btnViewPh.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        btnViewPh.setText("View Data");
        btnViewPh.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnViewPh.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnViewPhActionPerformed(evt);
            }
        });
        btnRESETbr.add(btnViewPh, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 440, 130, 40));
    ...
    private void phbranchcodetxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_phbranchcodetxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_phbranchcodetxtActionPerformed

    private void btnResetbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetbrActionPerformed
        // TODO add your handling code here:
        phbranchcodetxt.setText("");
        phphonenumtxt.setText("");
    }//GEN-LAST:event_btnResetbrActionPerformed

    private void phphonenumtxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_phphonenumtxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_phphonenumtxtActionPerformed
    ...
    private void btnADDbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnADDbrActionPerformed
        ...
        try{
            ...
            ps = sqlConn.prepareStatement("insert into phones(ph_br_code,ph_number)values(?,?)");

            ps.setString(1, phbrcode);
    ...
    private void btnUPDATEbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUPDATEbrActionPerformed
        ...
        try{
            updateAddDelPhones();
                ps = sqlConn.prepareStatement("UPDATE phones set ph_number=? WHERE ph_br_code=?");
                ps.setString(1,phnum);
                ps.setString(2, phbrcode);
                ps.executeUpdate();
    ...
    private void btnDELETEbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDELETEbrActionPerformed
        ...
        try{
            ...
            if(!(phnum.isEmpty()) && !(phbrcode.isEmpty())){
                ps = sqlConn.prepareStatement("DELETE FROM phones WHERE ph_br_code=? AND (ph_number LIKE ?)");
                ps.setString(1, phbrcode);
                ps.setString(2,phnum);
                ps.executeUpdate();
            }else{
                ps = sqlConn.prepareStatement("DELETE FROM phones WHERE ph_br_code=?");
                ps.setString(1, phbrcode);
                ps.executeUpdate();
            }
    ...
    private void btnViewPhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewPhActionPerformed
        // TODO add your handling code here:
         try{
            
            sqlConn = DriverManager.getConnection(dataB,username,password);
            PreparedStatement pst = sqlConn.prepareStatement("SELECT * FROM phones");
    ...
    }//GEN-LAST:event_btnViewPhActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(phonesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new phonesFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnViewPh;
    ...
    private javax.swing.JTextField phbranchcodetxt;
    private javax.swing.JTextField phphonenumtxt;
