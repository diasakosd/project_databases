...
public class guideFrame extends javax.swing.JFrame {
    ...
    public void updateAddDelGuide(){
        try{
             guiAT = guideATtxt.getText();
             guicv = guidecvtxt.getText();
    ...
    private void initComponents() {
        ...
        guideATtxt = new javax.swing.JTextField();
        ...
        guidecvtxt = new javax.swing.JTextField();
        ...
        guideATtxt.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        guideATtxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                guideATtxtActionPerformed(evt);
            }
        });
        btnRESETbr.add(guideATtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 460, 30));
        ...
        guidecvtxt.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        guidecvtxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                guidecvtxtActionPerformed(evt);
            }
        });
        btnRESETbr.add(guidecvtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 390, 460, 30));
    ...
    private void guideATtxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guideATtxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_guideATtxtActionPerformed
    ...
    private void btnUPDATEbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUPDATEbrActionPerformed
        ...
        try{
            ...
            ps = sqlConn.prepareStatement("UPDATE guide set gui_cv=? WHERE gui_AT=?");

            ps.setString(1,guicv);
            ps.setString(2, guiAT);
    ...
    private void btnADDbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnADDbrActionPerformed
        ...
        try{
            ...
            ps = sqlConn.prepareStatement("insert into guide(gui_AT,gui_cv)values(?,?)");

            ps.setString(1, guiAT);
            ps.setString(2,guicv);
    ...
    private void btnDELETEbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDELETEbrActionPerformed
        ...
        try{
            ...
            ps = sqlConn.prepareStatement("DELETE FROM guide WHERE gui_AT=?");
    ...
    private void guidecvtxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guidecvtxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_guidecvtxtActionPerformed
    ...
    private void btnViewMngActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewMngActionPerformed
        ...
        try{
            ...
            sqlConn = DriverManager.getConnection(dataB,username,password);
            PreparedStatement pst = sqlConn.prepareStatement("SELECT * FROM guide");
    ...
    private javax.swing.JTextField guideATtxt;
    private javax.swing.JTextField guidecvtxt;
